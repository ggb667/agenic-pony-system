...
BRANCH_VERIFIED: yes
STATUS: ACTIVE
PUSH_STATUS: source_state_pending_commit
...
BLOCKERS: none
NEXT_STEP: await Codex Twilight/Pinkie implementation report for durable `/tell`, then review the TUI contract and align source validation/documentation
