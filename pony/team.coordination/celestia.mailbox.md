...
## Pending Items
- Twilight notice: the source-repo Celestia launcher profile contract is now `celestia` instead of `just_you`; treat `celestia` as the supported source-of-truth name in launcher refresh and installed-project validation notes.
