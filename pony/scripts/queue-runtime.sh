...
ensure_runtime_layout() {
  ...
  [[ -f "$AGENIC_PROJECT_PONY_RUNTIME_STATE_PATH" ]] || printf 'ready\n' >"$AGENIC_PROJECT_PONY_RUNTIME_STATE_PATH"
  if [[ -f "$AGENIC_PROJECT_PONY_RUNTIME_STATE_PATH" ]]; then
    local current_state=""
    read -r current_state <"$AGENIC_PROJECT_PONY_RUNTIME_STATE_PATH" || current_state=""
