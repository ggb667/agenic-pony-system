...
load_project_paths() {
  ...
  export AGENIC_STATE_ROOT="$project_root/.agenic-pony"
  export AGENIC_AGENT_WORK_DIR="$AGENIC_STATE_ROOT/agent-work"
  export AGENIC_TEAM_COORDINATION_DIR="$AGENIC_STATE_ROOT/team.coordination"
}
