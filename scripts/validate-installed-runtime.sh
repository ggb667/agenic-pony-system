...
installed_twi_memory="$resolved_target_root/pony/memory/twi.md"
installed_aj_memory="$resolved_target_root/pony/memory/aj.md"
...
require_file "$installed_twi_memory" "installed Twilight memory capsule"
require_file "$installed_aj_memory" "installed Applejack memory capsule"
